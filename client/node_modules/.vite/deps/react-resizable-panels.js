...
var Q;
function at() {
  return Q === void 0 && (typeof matchMedia == "function" ? Q = !!matchMedia("(pointer:coarse)").matches : Q = false), Q;
}
function lt(e) {
...
function ve(e) {
  ...
  n.forEach((s) => {
    o.add(s.group), s.panels.forEach((f) => {
      i.add(f);
    }), s.separator && (a.add(s.separator), r || (r = true, s.separator.element.focus()));
...
function vt(e) {
  ...
  }), j.get(m) === 1 && (m.addEventListener("pointerdown", ve, true), m.addEventListener("pointerleave", ze), m.addEventListener("pointermove", be), m.addEventListener("pointerup", we, true)), function() {
    t = false, j.set(
      m,
      ...
      ve,
      true
    ), m.removeEventListener("pointerleave", ze), m.removeEventListener("pointermove", be), m.removeEventListener("pointerup", we, true)), a.disconnect();
  };
}
function $e() {
...
var $ = typeof window < "u" ? import_react.useLayoutEffect : import_react.useEffect;
function te(e) {
...
function zt(e, t) {
  ...
  (0, import_react.useImperativeHandle)(t, () => n.current, []), $(() => {
    Object.assign(
      n.current,
      Ie({ groupId: e })
    );
...
function bt({
  ...
  const h = (0, import_react.useRef)({}), m = te((b) => {
    U(h.current, b) || (h.current = b, s?.(b));
  }), c = ce(r), d = (0, import_react.useRef)(null), [S, y] = $e(), v = (0, import_react.useRef)({
  ...
  }), (0, import_jsx_runtime.jsx)(je.Provider, { value: L, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...p,
      "aria-orientation": u,
...
function Dt({
  ...
  const i = t !== void 0, a = "id" in o ? o.id : o.groupId, l = se(a, t ?? []), r = (0, import_react.useSyncExternalStore)(
    Lt,
    () => n.getItem(l),
    () => n.getItem(l)
...
function Rt(e, t) {
  ...
  (0, import_react.useImperativeHandle)(t, () => o.current, []), $(() => {
    Object.assign(
      o.current,
...
function Ct({
  ...
  const m = !!l, c = ce(l), d = (0, import_react.useRef)(null), S = fe(d, a), [, y] = $e(), { getPanelStyles: v, id: x, registerPanel: g } = de(), L = u !== null, P = te(
    (b, w, C) => {
      u?.(b, l, C);
    }
  );
...
function kt({
  ...
  const l = ce(o), [r, s] = (0, import_react.useState)({}), [u, f] = (0, import_react.useState)("inactive"), p = (0, import_react.useRef)(null), h = fe(p, n), {
    id: m,
    orientation: c,
    registerSeparator: d
  ...
  }, [m, l, d]), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...a,
