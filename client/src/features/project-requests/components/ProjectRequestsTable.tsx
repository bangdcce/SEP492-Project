...
interface ProjectRequestsTableProps {
  ...
  requestHrefBuilder?: (request: ProjectRequest) => string;
}
      ...
      <Table>
        ...
        <TableBody>
          {requests.map((request) => {
            const requestHref =
              requestHrefBuilder?.(request) ?? `/broker/project-requests/${request.id}`;
                    ...
                    {request.status === RequestStatus.PUBLIC_DRAFT &&
                      ...
                      (() => {
                        const hasApplied = request.brokerProposals?.some(
                          (proposal: any) => proposal.brokerId === currentUserId,
                        );
