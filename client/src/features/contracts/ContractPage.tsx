...
export default function ContractPage() {
  ...
  const handleSign = async () => {
    ...
    try {
      ...
      console.error(err);
      alert(
        "Failed to sign contract. Please check your password and try again.",
      ); // Generic error
    } finally {
      setIsSigning(false);
    }
              ...
              <CardContent className="space-y-4">
                <Alert className="bg-white">
                  ...
                  <AlertDescription className="text-xs">
                    By signing, you agree to the terms listed. This action
                    creates a cryptographic hash of the document and your
                    identity.
                  </AlertDescription>
                </Alert>
