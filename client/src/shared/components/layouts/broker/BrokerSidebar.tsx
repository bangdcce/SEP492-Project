 ...
 * Sidebar navigation for broker dashboard
 */
...
import {
  brokerSidebarMenuItems,
  sectionTitles,
} from "./brokerSidebarConfig";
import type { BrokerSidebarMenuItem } from "./brokerSidebarConfig";
...
export const BrokerSidebar: React.FC<BrokerSidebarProps> = ({
  isCollapsed = false,
  onToggleCollapse,
  className,
}) => {
  ...
  const groupedItems = brokerSidebarMenuItems.reduce((acc, item) => {
    const section = item.section || "main";
    if (!acc[section]) acc[section] = [];
    acc[section].push(item);
    return acc;
  }, {} as Record<string, BrokerSidebarMenuItem[]>);
