...
export class CreateTaskSubmissionTable1770358129036 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD CONSTRAINT "FK_34701b0b8d466af308ba202e4ef" FOREIGN KEY ("parentTaskId") REFERENCES "tasks"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "task_submissions" ADD CONSTRAINT "FK_244f39fcbecb5ec48e68b120f37" FOREIGN KEY ("submitterId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "task_links" ADD CONSTRAINT "FK_12e04786c9ec8436f467421b11d" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "task_links" DROP CONSTRAINT "FK_12e04786c9ec8436f467421b11d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "task_submissions" DROP CONSTRAINT "FK_8b64cdeb41cbea6ce153dde4881"`,
    );
    await queryRunner.query(
      `ALTER TABLE "task_submissions" DROP CONSTRAINT "FK_244f39fcbecb5ec48e68b120f37"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "task_links" ADD CONSTRAINT "FK_task_links_task" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD CONSTRAINT "FK_tasks_parentTask" FOREIGN KEY ("parentTaskId") REFERENCES "tasks"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
}
