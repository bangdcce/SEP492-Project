...
export class EditTaskEntity1769309514332 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "task_history" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(`ALTER TABLE "task_comments" DROP COLUMN "createdAt"`);
    await queryRunner.query(
      `ALTER TABLE "task_comments" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(`ALTER TABLE "task_comments" DROP COLUMN "updatedAt"`);
    await queryRunner.query(
      `ALTER TABLE "task_comments" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "task_comments" DROP COLUMN "createdAt"`);
    await queryRunner.query(
      `ALTER TABLE "task_comments" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(`ALTER TABLE "task_history" DROP COLUMN "createdAt"`);
    await queryRunner.query(
      `ALTER TABLE "task_history" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
  }
}
