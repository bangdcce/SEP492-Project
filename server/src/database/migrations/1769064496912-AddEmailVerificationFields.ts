...
export class AddEmailVerificationFields1769064496912 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "emailVerificationToken" character varying(64)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "registrationUserAgent" text`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_skill_domains" ADD CONSTRAINT "FK_4be126f755193c85b7b4359051b" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_skill_domains" ADD CONSTRAINT "FK_488f342c925037dc95dd38c4077" FOREIGN KEY ("domainId") REFERENCES "skill_domains"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_skill_domains" DROP CONSTRAINT "FK_488f342c925037dc95dd38c4077"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_skill_domains" DROP CONSTRAINT "FK_4be126f755193c85b7b4359051b"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."auto_schedule_rules_eventtype_enum_old" AS ENUM('DISPUTE_HEARING', 'PROJECT_MEETING', 'INTERNAL_MEETING', 'PERSONAL_BLOCK', 'REVIEW_SESSION', 'TASK_DEADLINE', 'OTHER')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."calendar_events_type_enum_old" AS ENUM('DISPUTE_HEARING', 'PROJECT_MEETING', 'INTERNAL_MEETING', 'PERSONAL_BLOCK', 'REVIEW_SESSION', 'TASK_DEADLINE', 'OTHER')`,
    );
    await queryRunner.query(
