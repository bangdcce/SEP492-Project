...
export class UpdateWalletEscrowDisputeFeeConfig1767091212228 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_372920d813ceab29336fc5221e" ON "payout_methods" ("userId") `);
        await queryRunner.query(`CREATE TYPE "public"."escrows_status_enum" AS ENUM('PENDING', 'FUNDED', 'RELEASED', 'REFUNDED', 'DISPUTED')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f07f9d851481059289600bc412" ON "escrows" ("projectId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_54b1af06e01e858558a708d47c" ON "escrows" ("milestoneId") `);
        await queryRunner.query(`CREATE TYPE "public"."fee_configs_feetype_enum" AS ENUM('PLATFORM_FEE', 'BROKER_COMMISSION', 'WITHDRAWAL_FEE')`);
        ...
        await queryRunner.query(`ALTER TABLE "wallets" ADD "pendingBalance" numeric(15,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "wallets" ADD "heldBalance" numeric(15,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "wallets" ADD "totalDeposited" numeric(15,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "wallets" ADD "totalWithdrawn" numeric(15,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "wallets" ADD "totalEarned" numeric(15,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "wallets" ADD "totalSpent" numeric(15,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`CREATE TYPE "public"."wallets_status_enum" AS ENUM('ACTIVE', 'FROZEN', 'SUSPENDED')`);
        await queryRunner.query(`ALTER TABLE "wallets" ADD "status" "public"."wallets_status_enum" NOT NULL DEFAULT 'ACTIVE'`);
        await queryRunner.query(`ALTER TABLE "wallets" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD "fee" numeric(15,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD "netAmount" numeric(15,2)`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD "currency" character varying(3) NOT NULL DEFAULT 'VND'`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD "paymentMethod" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD "externalTransactionId" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "payout_requests" ADD "fee" numeric(15,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "payout_requests" ADD "netAmount" numeric(15,2) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payout_requests" ADD "currency" character varying(3) NOT NULL DEFAULT 'VND'`);
        ...
        await queryRunner.query(`ALTER TABLE "payout_requests" ADD "externalReference" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "payout_requests" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."disputes_result_enum" AS ENUM('PENDING', 'WIN_CLIENT', 'WIN_FREELANCER', 'SPLIT')`);
        await queryRunner.query(`ALTER TABLE "disputes" ADD "result" "public"."disputes_result_enum" NOT NULL DEFAULT 'PENDING'`);
        ...
        await queryRunner.query(`ALTER TABLE "disputes" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "wallets" DROP COLUMN "currency"`);
        await queryRunner.query(`ALTER TABLE "wallets" ADD "currency" character varying(3) NOT NULL DEFAULT 'VND'`);
        await queryRunner.query(`ALTER TYPE "public"."transactions_type_enum" RENAME TO "transactions_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."transactions_type_enum" AS ENUM('DEPOSIT', 'WITHDRAWAL', 'ESCROW_HOLD', 'ESCROW_RELEASE', 'REFUND', 'FEE_DEDUCTION')`);
        ...
        await queryRunner.query(`ALTER TYPE "public"."payout_requests_status_enum" RENAME TO "payout_requests_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."payout_requests_status_enum" AS ENUM('PENDING', 'APPROVED', 'PROCESSING', 'COMPLETED', 'REJECTED', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."disputes_status_enum" AS ENUM('OPEN', 'IN_MEDIATION', 'RESOLVED', 'REJECTED')`);
        ...
        await queryRunner.query(`ALTER TABLE "payout_requests" ADD CONSTRAINT "FK_90c93283fb9c279f41bcde3c51f" FOREIGN KEY ("payoutMethodId") REFERENCES "payout_methods"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payout_requests" ADD CONSTRAINT "FK_8f9cb3fd93e7a728acf64f61930" FOREIGN KEY ("transactionId") REFERENCES "transactions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payout_requests" ADD CONSTRAINT "FK_b52c23ed48d02fb1fe17449d2d6" FOREIGN KEY ("approvedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payout_methods" ADD CONSTRAINT "FK_372920d813ceab29336fc5221e6" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "escrows" ADD CONSTRAINT "FK_f07f9d851481059289600bc4128" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "escrows" ADD CONSTRAINT "FK_54b1af06e01e858558a708d47cb" FOREIGN KEY ("milestoneId") REFERENCES "milestones"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "escrows" ADD CONSTRAINT "FK_08723ed58ba58a217b8713f531d" FOREIGN KEY ("disputeId") REFERENCES "disputes"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "disputes" ADD CONSTRAINT "FK_8880a40e54bc9b4675323ca102e" FOREIGN KEY ("raisedById") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "disputes" ADD CONSTRAINT "FK_bcfa408d5738fa2c2550bc2c073" FOREIGN KEY ("defendantId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "disputes" ADD CONSTRAINT "FK_00ac6d80806ccdd62cf9c159785" FOREIGN KEY ("resolvedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "fee_configs" ADD CONSTRAINT "FK_42214cd963e2591ef028f0ebdd9" FOREIGN KEY ("updatedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "fee_configs" DROP CONSTRAINT "FK_42214cd963e2591ef028f0ebdd9"`);
        await queryRunner.query(`ALTER TABLE "disputes" DROP CONSTRAINT "FK_00ac6d80806ccdd62cf9c159785"`);
        await queryRunner.query(`ALTER TABLE "disputes" DROP CONSTRAINT "FK_bcfa408d5738fa2c2550bc2c073"`);
        await queryRunner.query(`ALTER TABLE "disputes" DROP CONSTRAINT "FK_8880a40e54bc9b4675323ca102e"`);
        await queryRunner.query(`ALTER TABLE "escrows" DROP CONSTRAINT "FK_08723ed58ba58a217b8713f531d"`);
        await queryRunner.query(`ALTER TABLE "escrows" DROP CONSTRAINT "FK_54b1af06e01e858558a708d47cb"`);
        await queryRunner.query(`ALTER TABLE "escrows" DROP CONSTRAINT "FK_f07f9d851481059289600bc4128"`);
        await queryRunner.query(`ALTER TABLE "payout_methods" DROP CONSTRAINT "FK_372920d813ceab29336fc5221e6"`);
        await queryRunner.query(`ALTER TABLE "payout_requests" DROP CONSTRAINT "FK_b52c23ed48d02fb1fe17449d2d6"`);
        await queryRunner.query(`ALTER TABLE "payout_requests" DROP CONSTRAINT "FK_8f9cb3fd93e7a728acf64f61930"`);
        await queryRunner.query(`ALTER TABLE "payout_requests" DROP CONSTRAINT "FK_90c93283fb9c279f41bcde3c51f"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."disputes_status_enum_old" AS ENUM('IN_REVIEW', 'OPEN', 'REJECTED', 'RESOLVED')`);
        await queryRunner.query(`ALTER TABLE "disputes" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payout_requests_status_enum_old" AS ENUM('COMPLETED', 'PENDING', 'PROCESSING', 'REJECTED')`);
        await queryRunner.query(`ALTER TABLE "payout_requests" ALTER COLUMN "status" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "payout_requests" ALTER COLUMN "status" TYPE "public"."payout_requests_status_enum_old" USING "status"::"text"::"public"."payout_requests_status_enum_old"`);
        await queryRunner.query(`ALTER TABLE "payout_requests" ALTER COLUMN "status" SET DEFAULT 'PENDING'`);
        await queryRunner.query(`DROP TYPE "public"."payout_requests_status_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."payout_requests_status_enum_old" RENAME TO "payout_requests_status_enum"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN "referenceId"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."transactions_status_enum_old" AS ENUM('CANCELED', 'FAILED', 'PENDING', 'SUCCESS')`);
        await queryRunner.query(`ALTER TABLE "transactions" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."transactions_type_enum_old" AS ENUM('DEPOSIT', 'HOLD', 'REFUND', 'RELEASE', 'WITHDRAWAL')`);
