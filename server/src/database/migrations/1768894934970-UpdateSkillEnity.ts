...
export class UpdateSkillEnity1768894934970 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_skills_priority_enum" AS ENUM('PRIMARY', 'SECONDARY')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_skills_verificationstatus_enum" AS ENUM('SELF_DECLARED', 'PORTFOLIO_LINKED', 'PROJECT_VERIFIED', 'ADMIN_VERIFIED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_f643baf957249229e5be5651e6" ON "user_skills" ("skillId", "verificationStatus") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c248539f79b9a09139010aa646" ON "user_skills" ("userId", "priority") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `COMMENT ON COLUMN "dispute_verdicts"."reasoning" IS 'Lý do phán quyết có cấu trúc (violatedPolicies, supportingEvidenceIds, factualFindings, legalAnalysis, conclusion)'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "staff_expertise" ADD CONSTRAINT "FK_fd18fc4e1930d961ced296f6e40" FOREIGN KEY ("staffId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "staff_expertise" ADD CONSTRAINT "FK_98e7bfa27a5dc3f1ea6854491f0" FOREIGN KEY ("skillId") REFERENCES "skills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "skills" ADD CONSTRAINT "FK_9efef6747eca479da5e43ef38d1" FOREIGN KEY ("domainId") REFERENCES "skill_domains"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "dispute_skill_requirements" ADD CONSTRAINT "FK_7f932413b0fcf2a2113c60fdb7b" FOREIGN KEY ("disputeId") REFERENCES "disputes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "dispute_skill_requirements" ADD CONSTRAINT "FK_724c0d98a342b4c1b800987b6da" FOREIGN KEY ("skillId") REFERENCES "skills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "dispute_skill_requirements" ADD CONSTRAINT "FK_07db9a3bc01a0ae9fb9a74aa54e" FOREIGN KEY ("addedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "skill_mapping_rules" ADD CONSTRAINT "FK_be9c9478a57973b539501713319" FOREIGN KEY ("skillId") REFERENCES "skills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "skill_mapping_rules" DROP CONSTRAINT "FK_be9c9478a57973b539501713319"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dispute_skill_requirements" DROP CONSTRAINT "FK_07db9a3bc01a0ae9fb9a74aa54e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dispute_skill_requirements" DROP CONSTRAINT "FK_724c0d98a342b4c1b800987b6da"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dispute_skill_requirements" DROP CONSTRAINT "FK_7f932413b0fcf2a2113c60fdb7b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "skills" DROP CONSTRAINT "FK_9efef6747eca479da5e43ef38d1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "staff_expertise" DROP CONSTRAINT "FK_98e7bfa27a5dc3f1ea6854491f0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "staff_expertise" DROP CONSTRAINT "FK_fd18fc4e1930d961ced296f6e40"`,
    );
    await queryRunner.query(
