...
const endpoints = loadServiceControllerEndpoints('user-warnings');

describe('User warnings controller task batch', () => {
  jest.setTimeout(300000);
  const runtime = createServiceControllerGroupRuntime('user-warnings');
